...
<%-- Beginning of custom code - 2fa validation --%>
<c:set var="ignoredQueryParams" value=",2fa,loginOp,loginNewPassword,totpcode,loginConfirmNewPassword,loginErrorCode,username,email,password,zrememberme,ztrusteddevice,zlastserver,client,"/>
<%-- End of custom code - 2fa validation --%>
